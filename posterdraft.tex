\documentclass[portrait,a1paper,fontscale=0.47]{baposter}
...
\begin{poster}{
 ...
 {\flushleft{\includegraphics[scale=0.75]{Poster-images/Biomodels_logo.png}}}
 }
 ...
 The possibility of using SBO terms to track which models certain species apperared in was explored. However, a problem was found, demostrated in the table below: 
  ...
  {\flushleft{
  \footnotesize{
    \captionof{table}{Species SBO terms in the first biomodel}
      \label{tab:name}
      \begin{tabular}{ | p{1.6cm} | p{2.1cm} | p{1.1cm} | }
    \hline
