...
\begin{poster}{
 ...
 \includegraphics[trim= 1.5mm 5mm 5mm 5mm, clip, scale=0.4]{Poster-images/ReactionsHistogram.png} 
  The two graphs above show the number of species and reactions for each biomodel. As shown above, the patterns are very similar with the majority of models having less than 20 species and reactions and only a small number having more than 100 species or reactions.
  
  The graph to the left is a histogram of the ratio of species to reactants in each biomodel. As shown in the graph, the most frequent range is range of values is 0.5-1.0 with the majority of models having ratios less than 2. This suggests that either the reactions in the models tend to involve only a couple of species and that the species in each model tend to be involved in multiple reactions.
 \end{multicols}
 }
