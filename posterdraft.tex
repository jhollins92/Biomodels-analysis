...
\begin{poster}{
  ...
  {\includegraphics[width=14em]{Poster-images/ncl.jpg}}
  {\bf\huge{Analysis of the Biomodels Database}\vspace{0.5em}
    \newline\newline}
  % Authors
{\vspace{-0.5em}\hspace{-10em}Sebastian Mellor* \& Colin Gillespie}
 ...
 One of the programming languages used by modellers submitting to the biomodels datbase is SBML. The models can also be downloaded from the database in SBML format.
  ...
  R is highly extensible via the installation of packages. An example is the package rsbml used to extract information from the models, by first reading the models SBML files into R and converting these to objects that can be worked with in R.
  }
