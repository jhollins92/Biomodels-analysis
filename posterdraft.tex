...
\begin{poster}{
 ...
 Biomodels Database is an online resource for storing and serving quantative models of biomedical  interest. The database is composed of two branches; the curated branch and the non-curated branch. This project focused on the curated branch of the database.
 
 All the models in the curated section of BioModels Database have been described in peer-reviewed scientific literature and are compliant with the standard of model curation and annotation. Currently, there are 421 curated models in the database.
 ...
 \begin{tabular}{l r}
 \includegraphics[trim= 1.5mm 5mm 5mm 5mm, clip, scale=0.4]{SpeciesHistogram.png} & \includegraphics[trim= 1.5mm 5mm 5mm 5mm, clip, scale=0.4]{ReactionsHistogram.png}\\
 \end{tabular}
 ...
 \begin{tabular}{l r}
 \includegraphics[trim= 1.5mm 5mm 5mm 5mm, clip, scale=0.4]{GlobalParametersHistogram.png} & \includegraphics[trim= 1.5mm 5mm 5mm 5mm, clip, scale=0.4]{LocalParametersHistogram.png}\\
 \end{tabular}
 ...
 \includegraphics[trim= 1.5mm 5mm 5mm 4.5mm, clip, scale=0.4]{CummulativeModelsPlot.png}
 \includegraphics[trim= 1.5mm 5mm 5mm 4.5mm, clip, scale=0.4]{CummulativeSpeciesPlot.png}
 \begin{multicols}{2}
...
mathematical symbols.
 ...
 In this project, a species is defined as having a 'connection' in a particular reaction if the sepcies occurs in that reaction (either as a reactant or product). 
 
 If the species is a reactant in a reaction, the species has a reactant connection in that reaction. If the species is a product in a reaction, the species has a reactant connection in that product.
 
 In the project, 5732 reactions and 3408 species were extracted and examined in order to calculate the average number of connections per species. It was found that the average number of connections per species is 5.334 (to 3 decimal places). 
 }
