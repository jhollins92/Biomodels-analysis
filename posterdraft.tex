...
mathematical symbols.
 ...
 The top left grpah is the histogram of the number of species in each biomodel. The majority of models have less than 20 species, suggesting that the models tend to have small numbers of species.
 ...
 \includegraphics[trim= 1.5mm 5mm 5mm 5mm, clip, scale=0.4]{Poster-images/ReactionsHistogram.png} 
  ...
  The histogram of reactions, the top right graph, displays a similar pattern, which suggests that the models tend to have low numbers of reactions.
 ...
 The above graphs shows how the number of biomodels in the curated branch of the database has varied over time. The increase in the number of models appears to be closer to expoential, suggesting that the rate at which models are added to the databse per year is increasing over time.
 ...
 The above graphs shows how the numebr of species in the curated branch of the database has varied over time. The increase in the number of species is slightly more random than for the number of models. The only pattern is that a large increase in one year precedes a smaller increase in the next year.
 ...
 Systems Biology Markup Language (SBML) is a modelling standard used for exchanging models between different software tools. An example of some SBML code is shown below:
 ...
 \item $\mu$ and $\alpha$ are parameters. Parameters are the numbers used in the desrciption of the rate laws of reactions, these rate laws describe how a species varies over time.
