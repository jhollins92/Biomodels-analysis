...
\begin{poster}{
 ...
 The focus of the project is the curated branch of the database. There are currently 421 models in this branch. These models have been described in peer reviewed sceintific literature.
...
mathematical symbols.
 ...
 The grpah above is the histogram of the number of species in each biomodel. The majority of models have less than 20 species, suggesting that the models tend to have small numbers of species.\\
 ...
 The graph above shows the number of biomodels in the curated branch against time. The increase in the number of models appears to be close to expoential, suggesting that the rate at which models are added to the databse per year is increasing over time.
