...
localparamspresent <- localparams != 0
...
df <- data.frame(IDs ,comparts ,specs ,reacts ,globalparams ,localparamspresent, localparams ,unknowspeciesproportions, unknowparmetersproportions,stringsAsFactors = FALSE)
